...
The dashboard is your home screen in LOSPOR. It gives you a quick overview of your activity and provides access to all your cases.
...
| **Case finished** | All three forms complete |
...
Click **New case** in the top navigation bar or the **New case** button in the empty state of the case list. This opens the case creation wizard starting with the preoperative form.
