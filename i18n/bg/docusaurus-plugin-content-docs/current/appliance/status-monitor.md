...
| --- | --- | --- |
| Verified backup | Завършило ли е и проверено ли е скорошно резервно копие? | [Архивиране и възстановяване](backup-restore.md) |
| Off-host backup acknowledgement | Пристигнало ли е отделното криптирано копие? | [Архивиране и възстановяване](backup-restore.md) |
| Installation secrets escrow | Съхранени ли са офлайн тайните от инсталацията? | [Архивиране и възстановяване](backup-restore.md) |
| Data retention purge | Изпълнено ли е задължението за заличаване? | [Експлоатация](operations.md#съхранение-на-данни) |
| Automatic case closure | Финализират ли се изтеклите случаи? | [Експлоатация](operations.md#автоматично-закриване-на-случаи) |
| Central delivery worker | Работи ли изходящият worker? | [Central enrollment](central-enrollment.md) |
| Appliance release | Публикувана ли е по-нова версия? | [Обновявания и съвместимост](updates-compatibility.md) |
| Update agent | Действа ли нещо по тази версия? | [Обновявания и съвместимост](updates-compatibility.md) |
| Update supply credentials | Може ли appliance да изтегли обновяване? | [Обновявания и съвместимост](updates-compatibility.md) |
| Release activation lock | Тече ли или е блокирало активиране? | [Обновявания и съвместимост](updates-compatibility.md) |
| Restore operation lock | Тече ли или е блокирало възстановяване? | [Архивиране и възстановяване](backup-restore.md) |
| Host storage capacity | Свършва ли дисковото пространство на хоста? | [Наблюдение на хоста](host-observability.md) |
| Host clock synchronization | Синхронизирано ли е времето на хоста? | [Наблюдение на хоста](host-observability.md) |
| Host backup freshness | Потвърждава ли хостът, че копието е скорошно? | [Наблюдение на хоста](host-observability.md) |
| HTTPS certificate expiry | Изтича ли скоро сертификатът? | [Наблюдение на хоста](host-observability.md) |
| Host service health | Работят ли дълготрайните услуги? | [Наблюдение на хоста](host-observability.md) |
| Host update-agent service | Жив ли е агентът на хоста? | [Наблюдение на хоста](host-observability.md) |
...
[Data retention purge](operations.md#съхранение-на-данни) и
[Автоматично закриване на случаи](operations.md#автоматично-закриване-на-случаи).
...
описани в [Предоставяне на Hospital акаунти](account-provisioning.md).
...
папка на пакет, избрано от папките, които сървърът е намерил (по име, тези с
`manifest.json`), или въведено; агентът с права `root` свързва тази заявка с включените скриптове и
...
[Импорт на терминология](terminology-import.md) за договорите за пакет,
...
- **Настройки на сайта** променят мрежовите списъци, контакта за поддръжка на
  ...
  прави промяната, се отказва. След инсталиране Status е отворен за всяка частна
  мрежа, а Research за никоя; **Изисква внимание днес** и **Готовност** показват това,
  докато ИТ екипът не зададе и двата списъка тук, и тази промяна изключва и
  превключвателя за всички частни мрежи. Имената, режимът на сертификата, портовете и
...
[Наблюдение на сървъра без лични данни](host-observability.md).
...
проверки в [Проверка на версията](release-validation.md).
