...
[Проверка на версията](release-validation.md).
...
[`losporctl-install.sh`](release-validation.md#проверка-и-инсталиране-при-клиента):
...
версия](release-validation.md#процедура-за-версия-с-един-поддържащ) за
