...
- **Hospital 1.4.7 preoperative assessment documentation.** Document the
  shared immutable catalog/profile model, relational answers, deterministic
  suggestions, and the release/vendoring boundary for the appliance.
